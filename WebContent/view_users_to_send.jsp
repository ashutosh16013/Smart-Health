...
List<String> display_friends=lg.display_end_users(detail_user.get(1));
%>
		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar"
				...
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="view_users_to_send.jsp">Send Requests</a></li>
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<h1 class="page-header">Current End Users not in friend-list</h1>
				...
				<input type="hidden" name="size" value= "<%=display_friends.size()%>"/>

					<%int size = display_friends.size();
						String btn_id = "btn_";
						String friend_id = "frnd_";
						for (int i=0;i<size;i++){
							
							String name = display_friends.get(i);
							
							%>
						<div class = "row">
						<div class="col-md-4"><p><%=i+1 %></p></div>
						<div class="col-md-4"><p name="<%=friend_id+(i+1)+""%>" value = "<%=name %>"><%=name %></p></div>
						<div class="col-md-4"><p><button class="btn btn-info" type="submit"
								name="<%=btn_id+(i+1)+""%>" value = "<%=name %>">Send Request</button></p></div>
						</div>
					<%
