...
/**
 * Servlet implementation class URL_for_image3
 */
//@WebServlet("/URL_for_image3")
public class URL_for_image3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public URL_for_image3() {
        super();
			...
			try{
				...
				while (iterator.hasNext()) {
                    ...
                    if (!item.isFormField()) {
            			...
            			forward[2] = false; name[2] = detail_user.get(1)+ "\\" + fileName;
            			Login obj = new Login();
            			obj.result = detail_user.get(1);
            			obj.upload_pic3(name[2]);
                    }
                }
